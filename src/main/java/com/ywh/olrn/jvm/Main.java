...
//        }
        String sourceCode = ""
            ...
            + "    }\n"
            + "}";
        ClassFile classFile = new ClassFile(SourceCodeCompiler.compile(sourceCode));
